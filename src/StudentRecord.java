...
public class StudentRecord {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the "+size+" student names: ");
        ...
        System.out.println("If you want to edit any record number , please enter the record number: else enter -1 to skip: ");
